...
const Admin = () => {
  ...
  const totalFollowers = creators.reduce((sum, creator) => sum + creator.details.analytics.followers, 0);
  const totalViews = creators.reduce((sum, creator) => sum + creator.details.analytics.totalViews, 0);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{loading ? "..." : totalCreators}</div>
            </CardContent>
          </Card>
