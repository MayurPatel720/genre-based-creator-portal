...
const Filters: React.FC<FiltersProps> = ({ filters, onFiltersChange, onClearFilters }) => {
  const platforms = ['All', 'Instagram', 'YouTube', 'TikTok', 'Twitter', 'Other'];
  const locations = ['All', 'USA', 'UK', 'Canada', 'Australia', 'India', 'Other'];
      ...
      <div className="space-y-2">
        ...
        <div className="px-2">
          <Slider
            ...
            onValueChange={(value) => handleFilterChange('followersRange', value)}
            max={1000}
            min={0}
            step={10}
            className="w-full"
